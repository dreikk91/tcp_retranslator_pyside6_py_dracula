...
class ConfigPage:
    ...
    def init_config(self):
        ...
        self.postgres_address = str(
            self.config["databases"]["postgres"]["postgres_address"]
        )
        self.postgres_password = str(
            self.config["databases"]["postgres"]["postgres_password"]
        )
        self.postgres_username = str(
            self.config["databases"]["postgres"]["postgres_user"]
        )
        self.postgres_database = str(
            self.config["databases"]["postgres"]["postgres_database"]
        )

        self.sqlite_database_name = str(
            self.config["databases"]["sqlite"]["sqlite_database_name"]
        )
    ...
    def retrieve_data(self):
        ...
        self.left_table_row_count = int(
            self.ui.lineEdit_incoming_table_row_count.text()
        )
        self.right_table_row_count = int(
            self.ui.lineEdit_outgoing_table_row_count.text()
        )
